...
def ResourceEnhancer(id, title):
    ...
    if ALEXANDER_STREET_TARGET in id.lower():
        ...
        data['embed'] = '<iframe allow="encrypted-media;" src="https://www.remote.uwosh.edu/login?url=https://uwosh.kanopy.com/embed/' + data['id'] + '" frameborder="0" allowfullscreen webkitallowfullscreen mozallowfullscreen scrolling="no"></iframe>'
